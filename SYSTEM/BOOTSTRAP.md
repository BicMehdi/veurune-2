...
2. Résoudre le tour selon l’interprétation déléguée de Mehdi, mais rendre la main avant tout choix majeur défini par `rules/NARRATION_DARK_FANTASY.md`, sans exposer de secret MJ. Pour toute incertitude mécanique, utiliser `roll_dice`, les valeurs de `MEHDI_SHEET` et la section mécanique ciblée du Master.
